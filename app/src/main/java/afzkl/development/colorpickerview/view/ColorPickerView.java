...
public class ColorPickerView extends View {
     ...
     * the finger tracker will getInstance clipped when
    ...
    public boolean onTrackballEvent(MotionEvent event) {
        ...
        if (update) {
            ...
            if (mListener != null) {
                mListener.onColorChanged(this, Color.HSVToColor(mAlpha, new float[]{mHue, mSat, mVal}));
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY || heightMode == MeasureSpec.EXACTLY) {
            ...
            if (widthMode == MeasureSpec.EXACTLY && heightMode != MeasureSpec.EXACTLY) {
                ...
                //If we getInstance here the dev has set the width and height to exact sizes. For example match_parent or 300dp.
                //This will mean that the sat/val panel will not be square but it doesn't matter. It will work anyway.
                //In all other scenario our goal is to make that panel square.
    ...
    /**
     * Set a OnColorChangedListener to getInstance notified when the color
     ...
     *
     * @param color    The color that should be selected.
     * @param callback If you want to getInstance a callback to
