...
import rbb.hishoot2i.template.TemplateConstants
...
class AppPref : KotprefModel() {
    ...
    // BackgroundTool
    var backgroundModeId by intPref(default = BackgroundMode.ID_COLOR)
    ...
    // TemplateTool
    var templateCurrentId by stringPref(default = TemplateConstants.DEFAULT_TEMPLATE_ID)
    ...
    var badgePositionId by intPref(default = BadgePosition.CENTER_BOTTOM)
    var badgeText by stringPref(default = BADGE_TEXT)
    /* path plus quotation `"`  */
    ...
    // Template Manager
    val templateFavSet by stringSetPref { setOf(TemplateConstants.DEFAULT_TEMPLATE_ID) }
    var templateSortId by intPref(default = TemplateComparator.NAME_ASC_ID)
    //
    ...
    companion object {
        ...
        private const val BADGE_TEXT = "HISHOOT"
