 ...
 */
package org.illegaller.ratabb.hishoot2i.preference;
...
public class SeekBarPreference extends Preference implements
	...
	public SeekBarPreference(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			mMonitorBoxEnabled = attrs.getAttributeBooleanValue(null,
					"monitorBoxEnabled", false);
	...
	protected View onCreateView(ViewGroup parent) {
		...
		mMonitorBox
				.setVisibility(mMonitorBoxEnabled ? View.VISIBLE : View.GONE);
